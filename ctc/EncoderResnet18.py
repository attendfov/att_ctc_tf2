  ...
  def __init__(self,
    ...
    if rnn_type == 'rnn':
        self.bilstm0 = tf.keras.layers.Bidirectional(
            layers.SimpleRNN(units=lstm_unit, return_sequences=True, name='encode_lstm0'),
            name='bilstm0')
        self.bilstm1 = tf.keras.layers.Bidirectional(
            layers.SimpleRNN(units=lstm_unit, return_sequences=True, name='encode_lstm1'),
            name='bilstm1')
    elif rnn_type == 'lstm':
        self.bilstm0 = tf.keras.layers.Bidirectional(
